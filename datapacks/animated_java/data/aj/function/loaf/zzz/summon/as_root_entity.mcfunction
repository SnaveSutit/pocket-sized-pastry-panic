...
execute on passengers if entity @s[tag=aj.loaf.node.root] run function aj:loaf/zzz/summon/as_node/root
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
...
function aj:loaf/zzz/set_default_pose
execute if data storage animated_java:temp args.variant run function aj:loaf/zzz/summon/zzz/variant_arg/no_variants_warning
